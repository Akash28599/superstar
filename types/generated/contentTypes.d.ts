...
export interface ApiCocoHeadCocoHead extends Struct.CollectionTypeSchema {
  collectionName: 'coco_heads';
  info: {
    displayName: 'coco_head';
    pluralName: 'coco-heads';
    singularName: 'coco-head';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    icon_description: Schema.Attribute.JSON;
    icons: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::coco-head.coco-head'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCocobannerCocobanner extends Struct.CollectionTypeSchema {
  collectionName: 'cocobanners';
  info: {
    displayName: 'cocobanner';
    pluralName: 'cocobanners';
    singularName: 'cocobanner';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFooterFooter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    title_description: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOurproductOurproduct extends Struct.CollectionTypeSchema {
  collectionName: 'ourproducts';
  info: {
    displayName: 'ourproduct';
    pluralName: 'ourproducts';
    singularName: 'ourproduct';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSitesettingSitesetting extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tiktokurl: Schema.Attribute.Text;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::coco-head.coco-head': ApiCocoHeadCocoHead;
      'api::cocobanner.cocobanner': ApiCocobannerCocobanner;
